...
public class ExaminationSubmitAdapter4 extends PagerAdapter {
	SimulationTestActivity mContext;
	// 传递过来的页面view的集合
	List<View> viewItems;
	// 每个item的页面view
	View convertView;
	...
	boolean isContains;
	public ExaminationSubmitAdapter4(SimulationTestActivity context, List<View> viewItems, List<AnSwerInfo.DataBean> dataItems, String imgServerUrl) {
