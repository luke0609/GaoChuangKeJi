...
import com.jiaokaokeji.gaochuangkeji.book.adapter.ExaminationSubmitAdapter3;
...
public class Order1Activity extends AppCompatActivity  {
    ...
    ExaminationSubmitAdapter3 pagerAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DBManager dbManager = new DBManager(Order1Activity.this);
        dbManager.openDB1();
    ...
    private void loadData() {
        if (info1 == null) {
            Toast.makeText(Order1Activity.this, "暂无数据，请检查网络连接是否正常，如正常请退出耐心等待",
            ...
            pagerAdapter = new ExaminationSubmitAdapter3(
                    Order1Activity.this,info1, viewItems,
    ...
    private void loadData1() {
        new Thread() {
            ...
            public void run() {//在run()方法实现业务逻辑；
                if (info1 == null) {
                    Toast.makeText(Order1Activity.this, "暂无数据",
                            Toast.LENGTH_SHORT).show();
                } else {
