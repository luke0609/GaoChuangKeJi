...
public class ExaminationSubmitAdapter1 extends PagerAdapter {
	Radom1Activity mContext;
	// 传递过来的页面view的集合
	List<View> viewItems;
    ...
    public ExaminationSubmitAdapter1(Radom1Activity context,AnSwerInfo.DataBean[] info1, List<View> viewItems, List<AnSwerInfo.DataBean> dataItems, String imgServerUrl) {
		...
		if(((!dataItems.get(position).getItem3().equals("")&&Integer.valueOf(dataItems.get(position).getAnswer())<7))){
			...
			holder.btqr.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
                    ...
                    Toast.makeText(mContext,isA+""+isB+""+isC+""+isD+"", Toast.LENGTH_SHORT).show();
