...
public class SimulationTestActivity extends AppCompatActivity {
    ...
    int[] num = new int[100];
    ExaminationSubmitAdapter4 pagerAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DBManager dbManager = new DBManager(SimulationTestActivity.this);
        dbManager.openDB1();
    ...
    private void loadData() {
        if (info1 == null) {
            Toast.makeText(SimulationTestActivity.this, "暂无数据，请检查网络连接是否正常，如正常请退出耐心等待",
            ...
            pagerAdapter = new ExaminationSubmitAdapter4(
                    SimulationTestActivity.this, viewItems,
    ...
    private void loadData1() {
        ...
        new Thread() {
            ...
            public void run() {//在run()方法实现业务逻辑；
                if (info1 == null) {
                    Toast.makeText(SimulationTestActivity.this, "暂无数据",
                            Toast.LENGTH_SHORT).show();
                } else {
...
//                            viewPager.setAdapter(pagerAdapter);
    ...
    protected void showTimeOutDialog(final boolean flag, final String backtype) {
        ...
        if (backtype.equals("0")) {
            ...
            content2.setText(100-errortopicNums+"");
    ...
    public void showSubmitDialog() {
        ...
        if (viewPager.getCurrentItem() == viewPager.getAdapter().getCount()-1) {
            final Dialog builder = new Dialog(SimulationTestActivity.this, R.style.dialog);
            builder.setContentView(R.layout.my_dialog);
            TextView title = (TextView) builder.findViewById(R.id.dialog_title);
            TextView content = (TextView) builder.findViewById(R.id.dialog_content);
            TextView content1 = (TextView) builder.findViewById(R.id.tv1);
            content1.setText(100-errortopicNums+"");
            final Button confirm_btn = (Button) builder
                    .findViewById(R.id.dialog_sure);
            Button cancel_btn = (Button) builder.findViewById(R.id.dialog_cancle);
            confirm_btn.setVisibility(View.GONE);
