...
public class ExaminationSubmitAdapter3 extends PagerAdapter {
	Order1Activity mContext;
	// 传递过来的页面view的集合
	List<View> viewItems;
    ...
    public ExaminationSubmitAdapter3(Order1Activity context,AnSwerInfo.DataBean[] info1, List<View> viewItems, List<AnSwerInfo.DataBean> dataItems, String imgServerUrl) {
