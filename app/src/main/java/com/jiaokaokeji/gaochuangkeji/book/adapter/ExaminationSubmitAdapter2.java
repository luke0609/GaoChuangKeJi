...
public class ExaminationSubmitAdapter2 extends PagerAdapter {
	...
	boolean isContains;
	public ExaminationSubmitAdapter2(OrderActivity context,AnSwerInfo.DataBean[] info1, List<View> viewItems, List<AnSwerInfo.DataBean> dataItems, String imgServerUrl) {
