 ...
 * @author 金钟焕
 */
public class MymistakesDetail1Activity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.my_error_question_detail1);
	...
	private void initView(){
		...
		lel = ((LinearLayout) findViewById(R.id.leldaan));
		tvdanan = ((TextView) findViewById(R.id.tvdaan));
...
//				layoutE.setVisibility(View.GONE);
		...
		if(!url.equals("")){
			...
			Glide.with(MymistakesDetail1Activity.this).load(url).into(iv1);
		}else {
...
public void cuowu(){
	if(option_type.equals("0")){
		...
		if(questionAnswer.equals("7")){
			tvdanan.setText("AB");
		}else if(questionAnswer.contains("8")){
			tvdanan.setText("AC");
		}else if(questionAnswer.contains("9")){
			tvdanan.setText("AD");
		}else if(questionAnswer.contains("10")){
			tvdanan.setText("BC");
		}else if(questionAnswer.contains("11")){
			tvdanan.setText("BD");
		}
		else if(questionAnswer.contains("12")){
			tvdanan.setText("CD");
		}
		else if(questionAnswer.contains("13")){
			tvdanan.setText("ABC");
		}
		else if(questionAnswer.contains("14")){
			tvdanan.setText("ABD");
		}
		else if(questionAnswer.contains("15")){
			tvdanan.setText("ACD");
		}else if(questionAnswer.contains("16")){
			tvdanan.setText("BCD");
		}
		else if(questionAnswer.contains("17")){
			tvdanan.setText("ABCD");
		}
